...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('manage-community') }}">{{ $brVal }}</a></li>
    ...
    @endif
                    <form role="form" id="add-user" action="{{ route('manage-community-save') }}" name="add-category"
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <label for="community_name">Basic ecclessial community<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="community_name" name="community_name">
                                        <small class="text-danger">{{ $errors->first('community_name') }}</small>
                                    </div>
                                </div>
